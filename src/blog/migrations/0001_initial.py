    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(upload_to='category/', verbose_name='Poster')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('describe', models.CharField(max_length=400, verbose_name='Describe')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Author')),
                ('comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='blog.comment', verbose_name='Comment')),
        ...
        migrations.AddField(
            model_name='post',
            name='tags',
            field=models.ManyToManyField(blank=True, null=True, related_name='post_tag', to='blog.tag', verbose_name='Tags'),
        ),
        migrations.AddField(
            model_name='comment',
            name='post',
